///////////////////////////////////////////////////////////////////////////////
// Dictionary
var ss_$DictionaryCollection = ss.mkType(ss, 'ss.$DictionaryCollection',
	function#? DEBUG $DictionaryCollection$##(dict, isKeys) {
		this._dict = dict;
		this._isKeys = isKeys;
	},
	{
...
var ss_Dictionary$2 = ss.Dictionary$2 = ss.mkType(ss, 'ss.Dictionary$2', function#? DEBUG Dictionary$2$##(TKey, TValue) {
	var $type = ss.registerGenericClassInstance(ss_Dictionary$2, [TKey, TValue], function(o, cmp) {
		this.countField = 0;
		this.buckets = {};
	...
	}, null, null, function() { return [ ss_IDictionary, ss_IReadOnlyDictionary, ss_IEnumerable ]; });
	return $type;
});
