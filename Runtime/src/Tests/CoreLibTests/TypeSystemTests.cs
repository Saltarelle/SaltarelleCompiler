...
namespace CoreLibTests {
	...
	public class TypeSystemTests {
		...
		public void FullNamePropertyReturnsTheNameWithTheNamespace() {
			Assert.AreEqual(typeof(TypeSystemTests).FullName, "CoreLibTests.TypeSystemTests");
		}
		...
		public void TypeOfAnOpenGenericClassWorks() {
			Assert.AreEqual(typeof(G<,>).FullName, "CoreLibTests.TypeSystemTests$G$2");
		}

		[Test]
		public void TypeOfAnOpenGenericInterfaceWorks() {
			Assert.AreEqual(typeof(IG<>).FullName, "CoreLibTests.TypeSystemTests$IG$1");
		}

		[Test]
		public void TypeOfInstantiatedGenericClassWorks() {
			Assert.AreEqual(typeof(G<int,C>).FullName, "CoreLibTests.TypeSystemTests$G$2[ss.Int32,CoreLibTests.TypeSystemTests$C]");
		}

		[Test]
		public void TypeOfInstantiatedGenericInterfaceWorks() {
			Assert.AreEqual(typeof(IG<int>).FullName, "CoreLibTests.TypeSystemTests$IG$1[ss.Int32]");
		}
		...
		public void AccessingAStaticMemberInAGenericClassWorks() {
			Assert.AreEqual(G<int,C>.field, "ss.Int32 CoreLibTests.TypeSystemTests$C");
			Assert.AreEqual(G<C,int>.field, "CoreLibTests.TypeSystemTests$C ss.Int32");
			Assert.AreEqual(G<G<C,int>,G<string,C>>.field, "CoreLibTests.TypeSystemTests$G$2[CoreLibTests.TypeSystemTests$C,ss.Int32] CoreLibTests.TypeSystemTests$G$2[String,CoreLibTests.TypeSystemTests$C]");
		}

		[Test]
		public void TypeOfNestedGenericClassWorks() {
			Assert.AreEqual(typeof(G<int,G<C,IG<string>>>).FullName, "CoreLibTests.TypeSystemTests$G$2[ss.Int32,CoreLibTests.TypeSystemTests$G$2[CoreLibTests.TypeSystemTests$C,CoreLibTests.TypeSystemTests$IG$1[String]]]");
		}

		[Test]
		public void BaseTypeAndImplementedInterfacesForGenericTypeWorks() {
			Assert.AreEqual(typeof(G<int,G<C,IG<string>>>).BaseType.FullName, "CoreLibTests.TypeSystemTests$BX$1[CoreLibTests.TypeSystemTests$G$2[ss.Int32,CoreLibTests.TypeSystemTests$C]]");
			Assert.AreEqual(typeof(G<int,G<C,IG<string>>>).GetInterfaces()[0].FullName, "CoreLibTests.TypeSystemTests$IG$1[CoreLibTests.TypeSystemTests$G$2[CoreLibTests.TypeSystemTests$G$2[CoreLibTests.TypeSystemTests$C,CoreLibTests.TypeSystemTests$IG$1[String]],String]]");
		}
