...
namespace CoreLib.Plugin {
	public static class Messages {
		...
		public static readonly Tuple<int, MessageSeverity, string> _7162 = Tuple.Create(7162, MessageSeverity.Error, "The value type (struct) {0} cannot declare instance auto-properties, instance auto events or non-readonly instance fields");
