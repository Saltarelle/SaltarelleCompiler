...
namespace Saltarelle.Compiler {
	internal static class Messages {
		private static Dictionary<int, Tuple<MessageSeverity, string>> _allMessages = new Dictionary<int, Tuple<MessageSeverity, string>> {
			...
			{ 7112, Tuple.Create(MessageSeverity.Error, "The indexer {0} cannot be decorated with an [IntrinsicPropertyAttribute] because it is overridable.") },
			...
			{ 7522, Tuple.Create(MessageSeverity.Error, "Cannot use the type " + ut.FullName + " in a typeof expression because it is marked as not usable from script.") },
			{ 7523, Tuple.Create(MessageSeverity.Error, "Cannot perform method group conversion on " + rr.Conversion.Method.DeclaringType + "." + rr.Conversion.Method.Name + " because it is not a normal method.") },
			{ 7524, Tuple.Create(MessageSeverity.Error, "Cannot perform method group conversion on " + rr.Conversion.Method.DeclaringType + "." + rr.Conversion.Method.Name + " because it expands its param array in script.") },
			{ 7525, Tuple.Create(MessageSeverity.Error, "") },
			{ 7526, Tuple.Create(MessageSeverity.Error, "") },
			{ 7527, Tuple.Create(MessageSeverity.Error, "") },
			{ 7528, Tuple.Create(MessageSeverity.Error, "") },
			{ 7529, Tuple.Create(MessageSeverity.Error, "") },

			{ 7510, Tuple.Create(MessageSeverity.Error, "") },
			{ 7511, Tuple.Create(MessageSeverity.Error, "") },
			{ 7512, Tuple.Create(MessageSeverity.Error, "") },
			{ 7513, Tuple.Create(MessageSeverity.Error, "") },
			{ 7514, Tuple.Create(MessageSeverity.Error, "") },
			{ 7515, Tuple.Create(MessageSeverity.Error, "") },
			{ 7516, Tuple.Create(MessageSeverity.Error, "") },
			{ 7517, Tuple.Create(MessageSeverity.Error, "") },
			{ 7518, Tuple.Create(MessageSeverity.Error, "") },
			{ 7519, Tuple.Create(MessageSeverity.Error, "") },
		};
