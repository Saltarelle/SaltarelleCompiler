...
namespace Saltarelle.Compiler {
	internal static class Messages {
		private static Dictionary<int, Tuple<MessageSeverity, string>> _allMessages = new Dictionary<int, Tuple<MessageSeverity, string>> {
			...
			{ 7997, Tuple.Create(MessageSeverity.Error, "Aliased references are not supported.") },
			{ 7998, Tuple.Create(MessageSeverity.Error, "Unable to resolve the assembly reference {0}.") },
